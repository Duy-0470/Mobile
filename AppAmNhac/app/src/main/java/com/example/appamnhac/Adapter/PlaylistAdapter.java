...
public class PlaylistAdapter extends ArrayAdapter<Playlist> {
    ...
    class ViewHolder{
        ...
        ImageView imgbackground,imgplaylis;
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            viewHolder.imgplaylis = convertView.findViewById(R.id.imageviewplaylist);
        ...
        Picasso.with(getContext()).load(playlist.getIcon()).into(viewHolder.imgplaylis);
